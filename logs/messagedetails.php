            ...
            <?php
                    if(isset($_SESSION['username'])){
                        ...
                        while($row1 = mysqli_fetch_array($query1)){
                            $farmer_id = $row1['farmersID'];
                        }
                        if(isset($_GET['id'])){
                            $id = $_GET['id'];
                            $sql = "SELECT * FROM buyerregistration where buyer_id = '$id'";
                    ...
                    ?>
                            ...
                            <div class="write_up">
                                <div class="sent">
                                    <?php
                                    $sql4 = "SELECT * FROM messages where farmer_id = $farmer_id and buyer_id = $id ";
                                    ...
                                    $time = $row4['time'];
                                    if($pronoun == 'Me'){
                                        echo"<div class='message4'><span> $message4</span><br><span> <h7> $time</h7></span></br></div>";

                                    }
                                    else{
                                        echo"<div class='message5'><span> $message4</span></br><span> <h7> $time</h7></span></br></div>";
                                ...
                                <div class ="message1">
                                    <div>
                                        ...
                                        <input type ="text" name="pronoun" id="pro-text" value="Me" hidden >
...
if(isset($_POST['text'])){
  ...
  $sql3 = "INSERT INTO messages (farmer_id, buyer_id, message,pronoun ) values ('$farmer_id', '$id','$message','$pronoun')";
